...
export default defineConfig({
  ...
  locales: {
    ...
    en: {
      ...
      lang: 'en',
      title: "Vlog-Virginia's Blog",
      description: "Virginia's Personal Blog - Sharing technology, life and thoughts",
      themeConfig: {
        nav: [
          { text: 'Home', link: '/en/' },
  ...
  // 主题配置
  themeConfig: {
    logo: '/images/logo.svg', // 使用你上传的第二张图片
    ...
    // 社交链接
    socialLinks: [
      { icon: 'github', link: 'https://github.com/your-username/vlog-virginia-blog' }
    ],
    ...
    // 编辑链接
    editLink: {
      pattern: 'https://github.com/your-username/vlog-virginia-blog/edit/main/docs/:path',
