import { defineComponent, computed, createElementBlock, openBlock, unref, normalizeClass, createBlock, createCommentVNode, withCtx, createVNode, createElementVNode, Fragment, renderList, resolveDynamicComponent, createTextVNode, toDisplayString } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(breadcrumb)?.enabled ? (openBlock(), createBlock(unref(_sfc_main$1), {
          key: 0,
