import { defineComponent, provide, computed, watch, createElementBlock, createBlock, unref, openBlock, Fragment, renderSlot, createCommentVNode, createVNode, createSlots, renderList, withCtx, normalizeClass, resolveDynamicComponent, normalizeProps, mergeProps, guardReactiveProps } from 'vue';
...
import _sfc_main$s from '../../Home/src/index.vue2.mjs';
import _sfc_main$o from '../../HomeMyCard/src/HomeMyCardScreen.vue2.mjs';
import _sfc_main$7 from '../../BodyBgImage/src/index.vue2.mjs';
import _sfc_main$p from '../../FooterGroup/src/index.vue2.mjs';
import _sfc_main$q from '../../FooterInfo/src/index.vue2.mjs';
import _sfc_main$k from '../../ArticleImagePreview/src/index.vue2.mjs';
import _sfc_main$j from '../../ArticleAnalyze/src/index.vue2.mjs';
import _sfc_main$b from '../../ArticleShare/src/index.vue2.mjs';
import _sfc_main$g from '../../ArticleUpdate/src/index.vue2.mjs';
import _sfc_main$8 from '../../ArticleHeadingHighlight/src/index.vue2.mjs';
import _sfc_main$l from '../../ArticlePageStyle/src/index.vue2.mjs';
import _sfc_main$f from '../../ArticleAppreciation/src/AsideBottomAppreciation.vue2.mjs';
import _sfc_main$h from '../../ArticleAppreciation/src/DocAfterAppreciation.vue2.mjs';
import _sfc_main$i from '../../ArticleAppreciation/src/DocAfterAppreciationPopper.vue2.mjs';
...
import _sfc_main$m from '../../CodeBlockToggle/src/index.vue2.mjs';
import _sfc_main$a from '../../RightBottomButton/src/index.vue2.mjs';
import _sfc_main$9 from '../../Notice/src/index.vue2.mjs';
import _sfc_main$r from '../../ThemeEnhance/src/index.vue2.mjs';
import _sfc_main$n from '../../../common/VpContainer/src/index.vue2.mjs';
import _sfc_main$c from '../../ArchivesPage/src/index.vue2.mjs';
import _sfc_main$d from '../../CataloguePage/src/index.vue2.mjs';
import _sfc_main$e from '../../ArticleOverviewPage/src/index.vue2.mjs';
import _sfc_main$5 from '../../LoginPage/src/index.vue2.mjs';
import { useWatchLogin } from '../../LoginPage/src/useWatchLogin.mjs';
import _sfc_main$6 from '../../RiskLinkPage/src/index.vue2.mjs';
      ...
      return unref(teekConfig).teekTheme ? (openBlock(), createElementBlock(
        ...
        [
          ...
          unref(frontmatter).layout !== false ? (openBlock(), createElementBlock(
            ...
            { key: 2 },
            [
              unref(teekConfig).bodyBgImg?.imgSrc ? (openBlock(), createBlock(unref(_sfc_main$7), { key: 0 })) : createCommentVNode("v-if", true),
          ...
          createVNode(unref(Layout), {
            ...
            "layout-bottom": withCtx(() => [
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$p), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-footer-info-before"),
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$q), { key: 1 })) : createCommentVNode("v-if", true),
            ...
            "doc-after": withCtx(() => [
              ...
              unref(teekConfig).articleUpdate.enabled && unref(frontmatter).articleUpdate !== false ? (openBlock(), createBlock(unref(_sfc_main$g), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-doc-update-after"),
              renderSlot(_ctx.$slots, "teek-doc-after-appreciation-before"),
              unref(teekConfig).appreciation.position === "doc-after" ? (openBlock(), createBlock(unref(_sfc_main$h), { key: 1 })) : unref(teekConfig).appreciation.position === "doc-after-popper" ? (openBlock(), createBlock(unref(_sfc_main$i), { key: 2 })) : createCommentVNode("v-if", true),
            ...
            "aside-bottom": withCtx(() => [
              ...
              unref(teekConfig).appreciation.position === "aside-bottom" ? (openBlock(), createBlock(unref(_sfc_main$f), { key: 0 })) : createCommentVNode("v-if", true),
            ...
            "page-top": withCtx(() => [
              ...
              unref(isArticleOverviewPage) ? (openBlock(), createBlock(unref(_sfc_main$e), { key: 2 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-page-top-after")
            ]),
            "aside-outline-before": withCtx(() => [
              renderSlot(_ctx.$slots, "teek-article-share-before"),
              unref(teekConfig).articleShare.enabled ? (openBlock(), createBlock(unref(_sfc_main$b), { key: 0 })) : createCommentVNode("v-if", true),
