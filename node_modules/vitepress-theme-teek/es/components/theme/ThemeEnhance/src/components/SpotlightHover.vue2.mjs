        ...
        props.enabled && !shouldRecalculate.value ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            class: normalizeClass([
              unref(ns).joinNamespace("spotlight-hover"),
              unref(spotlightStyle) === unref(SpotlightStyle).Under ? unref(ns).joinNamespace("spotlight-hover__under") : "",
              unref(spotlightStyle) === unref(SpotlightStyle).Aside ? unref(ns).joinNamespace("spotlight-hover__aside") : ""
            ]),
            "aria-hidden": "true",
            focusable: "false"
          },
