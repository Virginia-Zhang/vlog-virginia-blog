...
export { inBrowser, is, isArray, isAsyncFunction, isBoolean, isClient, isDate, isDef, isElement, isEmpty, isExternal, isFocusable, isFunction, isIOS, isImageDom, isImgPath, isNull, isNullAndUnDef, isNullOrUnDef, isNumber, isObject, isPhone, isPromise, isServer, isString, isStringNumber, isType, isUnDef, isValidURL };
