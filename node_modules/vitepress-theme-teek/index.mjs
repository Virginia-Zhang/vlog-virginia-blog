  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock(
        "ul",
        {
          class: normalizeClass([unref(ns).b(), _ctx.root ? unref(ns).is("root") : unref(ns).is("nested")])
        },
        [
            ...
            renderList(_ctx.headers, ({ children, link, title }) => {
              return openBlock(), createElementBlock("li", { key: link }, [
                createElementVNode("a", {
                  ...
                  onClick,
                  title
                }, toDisplayString(title), 11, _hoisted_1$_),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns).b(), unref(ns).is("aside", _ctx.aside)])
        },
        [
...
var _sfc_main$1s = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("i", { innerHTML: _ctx.icon }, null, 8, _hoisted_1$Z);
    };
  }
});
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return _ctx.iconType === "unicode" ? (openBlock(), createElementBlock(
        ...
        2
        /* CLASS */
      )) : _ctx.iconType === "symbol" ? (openBlock(), createElementBlock("svg", _hoisted_2$I, [
      ...
      return openBlock(), createElementBlock(
        ...
        [
          unref(slot).default ? renderSlot(_ctx.$slots, "default", { key: 0 }) : isComponent() ? (openBlock(), createBlock(resolveDynamicComponent(finalIcon.value), {
            ...
            src: finalIcon.value,
            alt: _ctx.imgAlt
          }, null, 8, _hoisted_1$X)) : isSvgIcon() ? (openBlock(), createBlock(_sfc_main$1s, {
            key: 3,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isFontIcon() ? (openBlock(), createBlock(_sfc_main$1r, {
            key: 4,
            icon: finalIcon.value,
            iconType: getFontIconType()
          }, null, 8, ["icon", "iconType"])) : isIconifyOffline() ? (openBlock(), createBlock(_sfc_main$1q, {
            key: 5,
            icon: finalIcon.value
          }, null, 8, ["icon"])) : isIconifyOnline() ? (openBlock(), createBlock(_sfc_main$1p, {
            key: 6,
            icon: finalIcon.value
      ...
      return openBlock(), createElementBlock(
        ...
        [
          (_ctx.src || _ctx.srcSet) && !hasLoadError.value ? (openBlock(), createElementBlock("img", {
            ...
            onError: handleError
          }, null, 44, _hoisted_1$W)) : _ctx.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
            key: 1,
            icon: _ctx.icon
                ...
                createVNode(unref(TkFocusTrap), {
                  ...
                  default: withCtx(() => [
                    ...
                    createElementVNode(
                      ...
                      [
                        createVNode(unref(_sfc_main$1o), { icon: unref(closeIcon) }, null, 8, ["icon"])
                      ],
                      2
                      /* CLASS */
                    ),
                    ...
                    !isSingle.value ? (openBlock(), createElementBlock(
                      ...
                      [
                        createElementVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1o), { icon: unref(arrowLeftIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        ),
                        createElementVNode(
                          ...
                          [
                            createVNode(unref(_sfc_main$1o), { icon: unref(arrowRightIcon) }, null, 8, ["icon"])
                          ],
                          2
                          /* CLASS */
                        )
...
const createImageViewer = (options) => {
  ...
  instance = createVNode(_sfc_main$1i, options);
          ...
          createElementVNode(
            ...
            [
              withDirectives(createElementVNode("input", {
                ...
                step: _ctx.step,
                class: normalizeClass([unref(ns).e("label__input"), unref(ns).e("label__input-progress"), unref(ns).is("disabled", _ctx.disabled)])
      ...
      return openBlock(), createBlock(Transition, {
        ...
        default: withCtx(() => [
          withDirectives(createElementVNode("div", {
            ...
            iconComponent.value ? (openBlock(), createBlock(unref(_sfc_main$1o), {
              key: 1,
            ...
            _ctx.showClose ? (openBlock(), createBlock(unref(_sfc_main$1o), {
              key: 2,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        _ctx.prevText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : _ctx.prevIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
          key: 1,
          icon: _ctx.prevIcon
        }, null, 8, ["icon"])) : createCommentVNode("v-if", true)
      ], 8, _hoisted_1$R);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        ...
        _ctx.nextText ? (openBlock(), createElementBlock(
          ...
          1
          /* TEXT */
        )) : _ctx.nextIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
          key: 1,
          icon: _ctx.nextIcon
        }, null, 8, ["icon"])) : createCommentVNode("v-if", true)
      ], 8, _hoisted_1$Q);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        withDirectives(createElementVNode("input", {
          ...
          class: normalizeClass([unref(ns).e("input"), unref(ns).em("input", _ctx.size)])
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          showPrevMore.value ? (openBlock(), createElementBlock("li", {
            ...
            }, null, 8, _hoisted_3$u)) : (openBlock(), createElementBlock("span", {
              key: 1,
              innerHTML: unref(moreFilledIcon)
            }, null, 8, _hoisted_4$q))
          ], 42, _hoisted_2$C)) : createCommentVNode("v-if", true),
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList(pagers.value, (pager) => {
              return openBlock(), createElementBlock("li", {
                ...
                tabindex: tabindex.value
              }, toDisplayString(pager), 11, _hoisted_5$f);
            }),
            128
            /* KEYED_FRAGMENT */
          )),
          ...
          ], 42, _hoisted_6$c)) : createCommentVNode("v-if", true),
          _ctx.pageCount > 1 ? (openBlock(), createElementBlock("li", {
            ...
            tabindex: tabindex.value
          }, toDisplayString(_ctx.pageCount), 11, _hoisted_9$4)) : createCommentVNode("v-if", true)
        ],
        34
...
var _sfc_main$1a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const componentMap = computed(() => ({
      ...
      jumper: h(_sfc_main$1d, {
        size: props.size
      }),
      pager: h(_sfc_main$1b, {
        currentPage: currentPageModel.value,
      ...
      total: h(_sfc_main$1c, { total: isAbsent(props.total) ? 0 : props.total })
    }));
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns).b(), unref(ns).is("background", _ctx.background), unref(ns).m(_ctx.size)])
        },
        [
          (openBlock(true), createElementBlock(
            Fragment,
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          (openBlock(), createBlock(Teleport, {
            ...
            createVNode(Transition, {
              name: _ctx.transition ? _ctx.transitionName || unref(ns).joinNamespace("fade-linear") : ""
            }, {
              default: withCtx(() => [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("label", {
        class: normalizeClass([unref(ns).b(), unref(ns).is("active", model.value === _ctx.value && !_ctx.disabled), unref(ns).is("disabled", _ctx.disabled)]),
        title: _ctx.title,
        disabled: _ctx.disabled
      }, [
        withDirectives(createElementVNode("input", {
        ...
        createElementVNode(
          ...
          [
            _ctx.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
              key: 0,
              icon: _ctx.icon,
              "aria-hidden": "true"
            }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
        ...
        [
          (openBlock(true), createElementBlock(
            ...
            renderList(_ctx.options, (option) => {
              return openBlock(), createBlock(_sfc_main$18, mergeProps({
                key: option.name,
      ...
      return hasTitle.value || hasText.value ? (openBlock(), createElementBlock(
        ...
        [
          createElementVNode(
            ...
            [
              hasTitle.value ? (openBlock(), createElementBlock("div", _hoisted_1$L, [
                renderSlot(_ctx.$slots, "title", {}, () => [
                  createElementVNode("span", { innerHTML: _ctx.title }, null, 8, _hoisted_2$A)
                ])
              ])) : createCommentVNode("v-if", true),
              hasText.value ? (openBlock(), createElementBlock("p", _hoisted_3$s, [
                renderSlot(_ctx.$slots, "default", {}, () => [
                  createElementVNode("span", { innerHTML: _ctx.text }, null, 8, _hoisted_4$p)
                ])
              ])) : createCommentVNode("v-if", true)
            ],
            2
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", {
        ...
        _ctx.post.frontmatter.titleTag && _ctx.titleTagProps?.position === "left" ? (openBlock(), createBlock(unref(_sfc_main$16), mergeProps({
          key: 0,
        ...
        _ctx.post.frontmatter.titleTag && _ctx.titleTagProps?.position === "right" ? (openBlock(), createBlock(unref(_sfc_main$16), mergeProps({
          key: 1,
          text: _ctx.post.frontmatter.titleTag
        }, _ctx.titleTagProps, {
          "aria-label": _ctx.post.frontmatter.titleTag
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(breadcrumb)?.enabled ? (openBlock(), createBlock(unref(_sfc_main$1m), {
          key: 0,
                  ...
                  { key: index },
                  {
                    default: withCtx(() => [
                      (openBlock(), createBlock(resolveDynamicComponent(item.filePath ? "a" : "span"), {
                        href: item.filePath && unref(withBase$1)(`/${item.filePath}`),
                        title: item.fileName,
...
var _sfc_main$$ = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass([unref(ns).b(), _ctx.scope]),
        role: "group",
            ...
            return openBlock(), createElementBlock(
              ...
              [
                item.show && (item.data || item.dataList?.length) ? (openBlock(), createElementBlock("span", {
                  key: 0,
                  class: normalizeClass([unref(ns).e("item"), { split: _ctx.split }]),
                  role: "group",
                  "aria-label": item.title
                }, [
                  unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                    key: 0,
                    icon: item.icon,
                  ...
                  item.data ? (openBlock(), createElementBlock("a", {
                  ...
                  }, toDisplayString(item.data), 11, _hoisted_3$q)) : (openBlock(true), createElementBlock(
                    Fragment,
                    { key: 2 },
                    renderList(item.dataList, (data, index) => {
                      return openBlock(), createElementBlock("a", {
                        ...
                        class: normalizeClass([item.class, "hover-color"]),
                        "aria-label": data
                      }, toDisplayString(data), 11, _hoisted_4$n);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
      ...
      return openBlock(), createElementBlock("div", {
        ...
        isShowInfo.value ? (openBlock(), createElementBlock(
          ...
          [
            ...
            unref(docAnalysisConfig).wordCount || pageViewInfo.value.wordCount ? (openBlock(), createElementBlock("div", _hoisted_2$w, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.wordCount), 9, _hoisted_3$p)
            ])) : createCommentVNode("v-if", true),
            unref(docAnalysisConfig).readingTime || pageViewInfo.value.readingTime ? (openBlock(), createElementBlock("div", _hoisted_4$m, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                key: 0,
              ...
              }, toDisplayString(pageViewInfo.value.readingTime), 9, _hoisted_5$d)
            ])) : createCommentVNode("v-if", true),
            usePageView.value ? (openBlock(), createElementBlock("div", _hoisted_6$a, [
              unref(articleConfig).showIcon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                key: 0,
                icon: unref(viewIcon)
              }, null, 8, ["icon"])) : createCommentVNode("v-if", true),
              ...
              }, toDisplayString(statisticsInfo.value.isGet ? statisticsInfo.value.pagePv : "Get..."), 9, _hoisted_7$6)
            ])) : createCommentVNode("v-if", true)
          ],
          2
          /* CLASS */
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        docAfterOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
        ...
        }, null, 8, _hoisted_2$u)) : docAfterOptions.value.expandTitle || docAfterOptions.value.collapseTitle ? (openBlock(), createElementBlock("button", {
          key: 1,
          ...
          icon.value ? (openBlock(), createBlock(unref(_sfc_main$1o), {
            key: 0,
        ...
        createVNode(Transition, {
          ...
          default: withCtx(() => [
            ...
            ], 10, _hoisted_6$9)) : createCommentVNode("v-if", true)
          ]),
          _: 1
          /* STABLE */
        }, 8, ["name"])
        ...
        createVNode(unref(_sfc_main$19), {
          ...
          reference: withCtx(() => [
            docAfterPopperOptions.value.buttonHtml ? (openBlock(), createElementBlock("div", {
              ...
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns).e("content")}`
            }, null, 8, _hoisted_2$t)) : docAfterPopperOptions.value.title ? (openBlock(), createElementBlock("button", {
              key: 1,
              class: normalizeClass(unref(ns).e("button")),
              "aria-expanded": showContent.value,
              "aria-controls": `${unref(ns).e("content")}`,
              ...
              }, null, 8, _hoisted_4$k)) : createCommentVNode("v-if", true)
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(unref(_sfc_main$1t), {
        ...
        default: withCtx(() => [
          unref(frontmatter).title ? (openBlock(), createElementBlock("h1", _hoisted_1$C, [
            createTextVNode(
            ...
            renderList(enhancedCategories.value, (item) => {
              return openBlock(), createElementBlock(
                ...
                [
                  ...
                  }, toDisplayString(item.name) + " " + toDisplayString(unref(t)("tk.articleOverview.category")), 9, _hoisted_5$a),
                  createElementVNode("table", _hoisted_6$7, [
      ...
      return openBlock(), createElementBlock(
        ...
        [
          createElementVNode("button", {
            ...
            !unref(copied) ? (openBlock(), createElementBlock("div", _hoisted_2$r, [
              createVNode(unref(_sfc_main$1o), {
        ...
        [
          createElementVNode(
            ...
            [
              ...
              }, toDisplayString(unref(t)("tk.articleUpdate.label")), 9, _hoisted_1$A)) : (openBlock(), createElementBlock(
                "span",
                _hoisted_2$q,
...
var _sfc_main$Q = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const dataArray = computed(() => [bodyBgImgConfig.value.imgSrc || []].flat().map((item) => item && withBase$1(item)));
    const {
      data: imageSrc,
      start,
      index
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          unref(bodyBgImgConfig).mask ? (openBlock(), createElementBlock("div", _hoisted_1$z)) : createCommentVNode("v-if", true)
        ],
        6
        /* CLASS, STYLE */
      );
      ...
      return openBlock(), createElementBlock(
        ...
        [
          !_ctx.item.children ? (openBlock(), createElementBlock("a", {
            key: 0,
            href: _ctx.item.link && unref(withBase$1)(_ctx.item.link),
            ...
            _ctx.item.frontmatter.titleTag ? (openBlock(), createBlock(unref(_sfc_main$16), {
              key: 0,
          ...
          ], 8, _hoisted_1$y)) : (openBlock(), createElementBlock(
            Fragment,
            { key: 1 },
            [
              createElementVNode("div", {
                ...
                }, toDisplayString(`${_ctx.index}. ${_ctx.item.title}`), 9, _hoisted_5$9)
              ], 10, _hoisted_3$i),
        ...
        default: withCtx(() => [
          ...
          createElementVNode(
            ...
            [
              ...
              createElementVNode("ul", _hoisted_4$h, [
                (openBlock(true), createElementBlock(
                  Fragment,
                  null,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          }, null, 8, _hoisted_1$w)) : createCommentVNode("v-if", true),
          createElementVNode(
            "div",
            {
              id: artalkId,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          }, null, 10, _hoisted_1$t)) : createCommentVNode("v-if", true),
            ...
            [
              ...
              createElementVNode(
                ...
                [
                  ...
                  unref(playgroundUrl) ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                    key: 0,
                  ...
                  unref(githubUrl) ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                    key: 1,
              ...
              createVNode(unref(_sfc_main$15), null, {
                default: withCtx(() => [
                  withDirectives(createElementVNode("div", {
                    class: normalizeClass(unref(ns).joinNamespace("vp-code")),
              ...
              createVNode(Transition, {
                name: unref(ns).joinNamespace("fade-linear"),
                persisted: ""
              }, {
                default: withCtx(() => [
                  withDirectives(createElementVNode(
                    ...
                    [
                      createVNode(unref(_sfc_main$1o), { icon: unref(caretTopIcon) }, null, 8, ["icon"]),
                      createElementVNode(
                        "span",
                        null,
            ...
            renderList(unref(footerGroupConfig), (group, index) => {
              return openBlock(), createElementBlock("div", {
                ...
                createElementVNode(
                  ...
                  [
                    group.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                      key: 0,
                      icon: group.icon,
                      style: { "margin-right": "4px" },
                      "aria-hidden": "true"
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(group.links || [], (link, idx) => {
                      return openBlock(), createElementBlock(
                        ...
                        [
                          link.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                            key: 0,
                            icon: link.icon,
                            style: { "margin-right": "4px" },
                            "aria-hidden": "true"
                          ...
                          createElementVNode("a", {
                            ...
                            unref(isExternal)(link.link || "") ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                              key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return unref(footerInfo) || unref(social).length ? (openBlock(), createElementBlock("div", {
        key: 0,
        class: normalizeClass([unref(ns).b(), unref(ns).joinNamespace("wallpaper-outside")]),
        role: "contentinfo",
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList(unref(social), (item, index) => {
              return openBlock(), createElementBlock("a", {
                ...
                item.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                  key: 0,
                  ...
                  return openBlock(), createElementBlock(
                    ...
                    [
                      ...
                      item.link ? (openBlock(), createElementBlock("a", {
                        ...
                        target: "_blank",
                        "aria-label": item.name
                      }, toDisplayString(item.name), 9, _hoisted_7$3)) : (openBlock(), createElementBlock(
                        "span",
                        _hoisted_8$3,
                        toDisplayString(item.name),
                        1
    ...
    const coverImgMap = computed(() => {
      ...
      return {
        default: {
          is: "div",
          props: {
            style: `background-image: url(${withBase$1(imgSrcListConst[0])});`
          }
        },
        full: {
          is: "img",
          props: {
            src: withBase$1(imgSrcListConst[0])
          }
        }
      };
    });
            ...
            createElementVNode(
              ...
              [
                ...
                excerpt.value && unref(postConfig).excerptPosition === "top" ? (openBlock(), createElementBlock("div", {
                  ...
                  }, toDisplayString(unref(postConfig).moreLabel), 9, _hoisted_6$4)) : createCommentVNode("v-if", true)
                ...
                createElementVNode("div", {
                  ...
                  isShowInfo.value ? (openBlock(), createBlock(unref(_sfc_main$$), {
                    key: 0,
                    post: _ctx.post,
                    scope: "post",
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          !!_ctx.post.frontmatter.sticky ? (openBlock(), createBlock(unref(_sfc_main$1o), {
            key: 0,
            icon: unref(topIcon),
            class: "top",
            size: 40,
          ...
          createElementVNode(
            ...
            [
              ...
              excerpt.value ? (openBlock(), createElementBlock("span", {
                ...
                innerHTML: excerpt.value,
                "aria-label": unref(t)("tk.homePost.excerptLabel")
              }, null, 8, _hoisted_4$e)) : createCommentVNode("v-if", true),
              isShowInfo.value ? (openBlock(), createBlock(unref(_sfc_main$$), {
                key: 1,
                post: _ctx.post,
                scope: "post",
          ...
          currentPosts.value ? (openBlock(), createElementBlock(
            ...
            [
                    ...
                    (openBlock(true), createElementBlock(
                      ...
                      renderList(currentPosts.value, (post) => {
                        return openBlock(), createElementBlock(
                          ...
                          [
                            unref(postConfig).postStyle === "card" ? (openBlock(), createBlock(_sfc_main$D, {
                              key: 0,
                              post
                            }, null, 8, ["post"])) : (openBlock(), createBlock(_sfc_main$E, {
                              key: 1,
                              post,
              ...
              createElementVNode("div", {
                ...
                totalPostsCount.value >= pageSize.value ? (openBlock(), createBlock(unref(_sfc_main$1a), mergeProps({
                  key: 0,
...
var _sfc_main$A = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const dataArray = computed(() => [bannerConfig.value.imgSrc || []].flat().map((item) => item && withBase$1(item)));
    const {
      data: imageSrc,
      start,
      index
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        createElementVNode("h1", {
          class: normalizeClass(unref(ns).e("content__title")),
          "aria-label": unref(t)("tk.homeBanner.titleLabel")
        }, toDisplayString(unref(bannerConfig).name), 11, _hoisted_2$g),
        createElementVNode("p", {
          class: normalizeClass(unref(ns).e("content__desc")),
          ...
          isDefaultDescStyle.value ? (openBlock(), createElementBlock(
          ...
          }, toDisplayString(unref(text)), 9, _hoisted_5$5)), [
            [vShow, !!unref(text)]
            ...
            [
              ...
              }, toDisplayString(unref(typesText)), 9, _hoisted_6$3),
              createElementVNode(
                "span",
                {
              ...
              return withDirectives((openBlock(), createElementBlock("div", {
                ...
                feature.link ? (openBlock(), createElementBlock("a", {
                  ...
                  feature.imgUrl ? (openBlock(), createElementBlock("img", {
                    key: 0,
                    class: "feature-img",
                    src: unref(withBase$1)(feature.imgUrl),
                    alt: feature.title,
                    "aria-label": feature.title
                  }, null, 8, _hoisted_3$c)) : createCommentVNode("v-if", true),
                  createElementVNode("p", {
                    id: `feature-title-${index}`,
                    class: "feature-title"
                  }, toDisplayString(feature.title), 9, _hoisted_4$c),
                  createElementVNode(
                    "p",
                    _hoisted_5$4,
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          createElementVNode("div", {
            ...
            unref(bannerConfig).imgWaves && currentBgStyle.value.isBannerFullImgBgStyle && !currentBgStyle.value.isBodyImgBgStyle ? (openBlock(), createBlock(_sfc_main$x, {
              key: 0,
          ...
          [
            renderSlot(_ctx.$slots, "title", {}, () => [
              _ctx.titleLink ? (openBlock(), createElementBlock("a", {
                key: 0,
                href: unref(withBase$1)(_ctx.titleLink),
              ...
              ], 8, _hoisted_2$e)) : _ctx.titleClick ? (openBlock(), createElementBlock("a", {
                key: 1,
              ...
              ], 10, _hoisted_4$b)) : (openBlock(), createElementBlock("span", {
                key: 2,
                class: "title flx-align-center",
                innerHTML: _ctx.title
              }, null, 8, _hoisted_6$2))
            ...
            renderSlot(_ctx.$slots, "page", normalizeProps(guardReactiveProps({ pagination })), () => [
              _ctx.page ? (openBlock(), createElementBlock("div", _hoisted_7$1, [
...
var _sfc_main$u = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const avatarBgStyle = computed(() => ({ backgroundImage: `url(${withBase$1(blogger.value.circleBgImg)})` }));
      ...
      return openBlock(), createElementBlock(
        ...
        [
          ...
          renderSlot(_ctx.$slots, "teek-home-card-my", {}, () => [
            unref(blogger).name ? (openBlock(), createBlock(unref(_sfc_main$v), {
              key: 0,
              ...
              default: withCtx(() => [
                ...
                createElementVNode(
                  ...
                  [
                    unref(blogger).avatar ? (openBlock(), createBlock(unref(_sfc_main$1n), {
                      key: 0,
                      ...
                      "aria-hidden": "true"
                    }, null, 8, ["src", "size", "shape", "alt", "title"])) : (openBlock(), createBlock(unref(_sfc_main$1n), {
                      key: 1,
                      size: 100,
                      shape: shape.value,
          ...
          renderSlot(_ctx.$slots, "teek-home-card-top-article", {}, () => [
            createVNode(unref(_sfc_main$v), {
              ...
              default: withCtx(({ transitionName }) => [
                ...
                }, toDisplayString(unref(topArticleConfig).emptyLabel), 11, _hoisted_4$8))
              ]),
              _: 1
              /* STABLE */
              ...
              default: withCtx(({ transitionName }) => [
                categories.value.length ? (openBlock(), createBlock(TransitionGroup, {
                  ...
                  default: withCtx(() => [
                    ...
                    }, toDisplayString(unref(categoryConfig).moreLabel), 9, _hoisted_3$7)) : createCommentVNode("v-if", true)
                  ]),
                  _: 2
                  /* DYNAMIC */
                }, 1032, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
                ...
                }, toDisplayString(unref(categoryConfig).emptyLabel), 11, _hoisted_4$7))
              ]),
              _: 1
              /* STABLE */
        ...
        [
          ...
          renderSlot(_ctx.$slots, "teek-home-card-tag", {}, () => [
            createVNode(unref(_sfc_main$v), {
              ...
              class: normalizeClass([unref(ns).b(), unref(ns).is("page", _ctx.tagsPage)]),
              ...
              default: withCtx(({ transitionName }) => [
                tags.value.length ? (openBlock(), createBlock(TransitionGroup, {
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createElementBlock(
                      ...
                      renderList(currentTags.value, (item, index) => {
                        return openBlock(), createElementBlock("a", {
                          ...
                          class: normalizeClass([{ active: item.name === selectedTag.value }, unref(ns).joinNamespace("pointer")]),
                          "aria-label": item.name
                        }, [
                          createElementVNode(
                            "span",
                    ...
                    }, toDisplayString(unref(tagConfig).moreLabel), 9, _hoisted_3$6)) : createCommentVNode("v-if", true)
                  ]),
                  _: 2
                  /* DYNAMIC */
                }, 1032, ["name", "class", "aria-label"])) : (openBlock(), createElementBlock("div", {
                ...
                }, toDisplayString(unref(tagConfig).emptyLabel), 11, _hoisted_4$6))
              ]),
              _: 1
              /* STABLE */
            }, 8, ["page", "modelValue", "pageSize", "total", "title", "autoPage", "pageSpeed", "class", "aria-label"])
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("a", {
        ...
        createElementVNode("img", {
          src: _ctx.item.avatar && unref(withBase$1)(_ctx.item.avatar),
          class: "friend-avatar",
        ...
        createElementVNode(
          ...
          [
            ...
            }, toDisplayString(_ctx.item.name), 9, _hoisted_3$5),
            createElementVNode("div", {
              class: "friend-desc sle",
              title: _ctx.item.desc
            }, toDisplayString(_ctx.item.desc), 9, _hoisted_4$5)
          ],
          2
          /* CLASS */
        )
          ...
          renderSlot(_ctx.$slots, "teek-home-card-friend-link", {}, () => [
            createVNode(unref(_sfc_main$v), {
              ...
              default: withCtx(({ transitionName, startAutoPage, closeAutoPage }) => [
                ...
                }, toDisplayString(unref(friendLinkConfig).emptyLabel), 11, _hoisted_1$b))
              ]),
              _: 1
              /* STABLE */
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        unref(isHomePage) && (unref(teekConfig).banner.enabled ?? true) ? withDirectives((openBlock(), createElementBlock(
          ...
          _hoisted_2$6,
          [
            createVNode(unref(_sfc_main$w), { disabled: isPaging.value }, createSlots({
              _: 2
              /* DYNAMIC */
            }, [
        ...
        createElementVNode(
          "div",
          {
            class: normalizeClass([unref(ns).e("content"), unref(ns).joinNamespace("wallpaper-outside"), "flx-start-justify-center"])
          },
          [
            createElementVNode("div", {
        ...
        unref(teekConfig).wallpaper.enabled && (unref(teekConfig).banner.bgStyle === "fullImg" || unref(teekConfig).bodyBgImg.imgSrc) ? (openBlock(), createBlock(unref(_sfc_main$F), { key: 1 })) : createCommentVNode("v-if", true)
      ], 10, _hoisted_1$9);
    };
  }
});
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns$1).e("title"), unref(ns$1).is("disabled", !!_ctx.disabled)])
        },
        [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns).b(), unref(ns).is("active", Boolean(_ctx.active))])
        },
        [
          renderSlot(_ctx.$slots, "default")
        ],
      ...
      return openBlock(), createElementBlock("div", null, [
        createElementVNode(
          ...
          [
            ...
            _ctx.helper ? (openBlock(), createBlock(_sfc_main$j, {
              key: 0,
                        ...
                        return openBlock(), createElementBlock(
                          ...
                          [
                            createElementVNode("div", _hoisted_1$7, [
                              tip.icon ? (openBlock(), createBlock(unref(_sfc_main$1o), {
                                key: 0,
                                icon: tip.icon,
                                size: 16,
                                style: { "margin-right": "4px" }
        ...
        _ctx.borderHighlight ? (openBlock(), createBlock(_sfc_main$i, {
          key: 0,
          ...
          _: 3
          /* FORWARDED */
        }, 8, ["active"])) : (openBlock(), createElementBlock("div", _hoisted_4$3, [
          renderSlot(_ctx.$slots, "default")
        ]))
      ]);
    };
            ...
            renderList(themeColorSelectList.value, (item) => {
              return openBlock(), createElementBlock(
                ...
                [
                  ...
                  }, toDisplayString(item.label), 9, _hoisted_4$2),
                  createVNode(unref(_sfc_main$17), {
      ...
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        props.enabled && !shouldRecalculate.value ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            class: normalizeClass([
              unref(ns$1).joinNamespace("spotlight-hover"),
              unref(spotlightStyle) === unref(SpotlightStyle).Under ? unref(ns$1).joinNamespace("spotlight-hover__under") : "",
              unref(spotlightStyle) === unref(SpotlightStyle).Aside ? unref(ns$1).joinNamespace("spotlight-hover__aside") : ""
            ]),
            "aria-hidden": "true",
            focusable: "false"
          },
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          unref(spotlight) && !unref(isMobile) ? (openBlock(), createBlock(_sfc_main$b, {
            key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Transition, { name: unref(transitionName) }, {
        default: withCtx(() => [
          unref(spotlightToggledOn) ? (openBlock(), createBlock(_sfc_main$h, {
            key: 0,
            icon: unref(clickIcon),
...
var _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return !unref(isMobile) && unref(themeEnhanceConfig).position === "top" ? (openBlock(), createBlock(unref(_sfc_main$19), {
        key: 0,
        class: normalizeClass([unref(ns$1).b(), unref(ns$1).is(_ctx.position), "flx-align-center"]),
        ...
        default: withCtx(() => [
          createElementVNode(
            ...
            [
              ...
              !disabledList.value.themeColor ? (openBlock(), createBlock(_sfc_main$c, { key: 1 })) : createCommentVNode("v-if", true),
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        ...
        [
          ...
          commentConfig.value.enabled && commentConfig.value.provider ? (openBlock(), createBlock(_sfc_main$6, { key: 0 })) : createCommentVNode("v-if", true),
          !unref(isMobile) && unref(themeEnhanceConfig).position === "bottom" ? (openBlock(), createBlock(unref(_sfc_main$8), {
            key: 1,
            class: normalizeClass(unref(ns).e("button")),
            position: "bottom",
            "y-offset": 7
          ...
          !disabledThemeColor.value ? (openBlock(), createBlock(_sfc_main$5, { key: 2 })) : createCommentVNode("v-if", true),
            ...
            renderSlot(_ctx.$slots, "header", {}, () => [
              createElementVNode("div", {
                ...
                createVNode(unref(_sfc_main$1o), {
                  ...
                  color: "#ffffff",
                  size: "20px",
                  class: normalizeClass(unref(ns).joinNamespace("pointer")),
                  ...
                  createElementVNode(
                    ...
                    [
                      createElementVNode("button", {
                        ...
                        createVNode(unref(_sfc_main$1o), { icon: unref(refreshRightIcon) }, null, 8, ["icon"]),
                        createElementVNode(
                          "span",
                          null,
                      ...
                      createElementVNode("button", {
                        ...
                        createVNode(unref(_sfc_main$1o), { icon: unref(successFilledIcon) }, null, 8, ["icon"]),
                        createElementVNode(
                          "span",
                          null,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock(
        "div",
        {
          class: normalizeClass([unref(ns).b(), unref(ns).joinNamespace("center"), "flx-space-y-20"])
        },
        [
          createElementVNode(
            "div",
      ...
      return unref(teekConfig).teekTheme ? (openBlock(), createElementBlock(
        ...
        [
          ...
          unref(frontmatter).layout !== false ? (openBlock(), createElementBlock(
            ...
            { key: 2 },
            [
              unref(teekConfig).bodyBgImg?.imgSrc ? (openBlock(), createBlock(unref(_sfc_main$Q), { key: 0 })) : createCommentVNode("v-if", true),
          ...
          createVNode(unref(Layout), {
            class: normalizeClass([unref(ns).b(), { [unref(ns).m("hide-vp-home")]: !unref(teekConfig).vpHome }])
          }, createSlots({
            ...
            "layout-bottom": withCtx(() => [
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$H), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-footer-info-before"),
              unref(isHomePage) ? (openBlock(), createBlock(unref(_sfc_main$G), { key: 1 })) : createCommentVNode("v-if", true),
            ...
            "doc-before": withCtx(() => [
              ...
              unref(frontmatter).article !== false ? (openBlock(), createBlock(unref(_sfc_main$_), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-article-analyze-after"),
              createVNode(unref(_sfc_main$V)),
              createVNode(unref(_sfc_main$T)),
              !unref(teekConfig).codeBlock.disabled ? (openBlock(), createBlock(unref(_sfc_main$N), { key: 1 })) : createCommentVNode("v-if", true),
            ...
            "doc-after": withCtx(() => [
              ...
              unref(teekConfig).articleUpdate.enabled && unref(frontmatter).articleUpdate !== false ? (openBlock(), createBlock(unref(_sfc_main$R), { key: 0 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-doc-update-after"),
              renderSlot(_ctx.$slots, "teek-doc-after-appreciation-before"),
              unref(teekConfig).appreciation.position === "doc-after" ? (openBlock(), createBlock(unref(_sfc_main$Y), { key: 1 })) : unref(teekConfig).appreciation.position === "doc-after-popper" ? (openBlock(), createBlock(unref(_sfc_main$X), { key: 2 })) : createCommentVNode("v-if", true),
            ...
            "aside-bottom": withCtx(() => [
              ...
              unref(teekConfig).appreciation.position === "aside-bottom" ? (openBlock(), createBlock(unref(_sfc_main$Z), { key: 0 })) : createCommentVNode("v-if", true),
            ...
            "page-top": withCtx(() => [
              ...
              unref(isArticleOverviewPage) ? (openBlock(), createBlock(unref(_sfc_main$U), { key: 2 })) : createCommentVNode("v-if", true),
              renderSlot(_ctx.$slots, "teek-page-top-after")
            ]),
            "aside-outline-before": withCtx(() => [
              renderSlot(_ctx.$slots, "teek-article-share-before"),
              unref(teekConfig).articleShare.enabled ? (openBlock(), createBlock(unref(_sfc_main$S), { key: 0 })) : createCommentVNode("v-if", true),
...
export { LayoutMode, SpotlightStyle, StorageSerializers, TeekConfigProvider, ThemeColor, _sfc_main$11 as TkArchivesPage, _sfc_main$_ as TkArticleAnalyze, _sfc_main$10 as TkArticleBreadcrumb, _sfc_main$W as TkArticleHeadingHighlight, _sfc_main$V as TkArticleImagePreview, _sfc_main$$ as TkArticleInfo, _sfc_main$U as TkArticleOverviewPage, _sfc_main$1t as TkArticlePage, _sfc_main$T as TkArticlePageStyle, _sfc_main$S as TkArticleShare, _sfc_main$12 as TkArticleTitle, _sfc_main$R as TkArticleUpdate, _sfc_main$Z as TkAsideBottomAppreciation, _sfc_main$1n as TkAvatar, _sfc_main$Q as TkBodyBgImage, _sfc_main$1m as TkBreadcrumb, _sfc_main$1l as TkBreadcrumbItem, _sfc_main$P as TkCatalogueItem, _sfc_main$O as TkCataloguePage, _sfc_main$N as TkCodeBlockToggle, _sfc_main$M as TkCommentArtalk, _sfc_main$L as TkCommentGiscus, _sfc_main$K as TkCommentTwikoo, _sfc_main$J as TkCommentWaline, _sfc_main$I as TkDemoCode, _sfc_main$Y as TkDocAfterAppreciation, _sfc_main$X as TkDocAfterAppreciationPopper, _sfc_main$1u as TkDocAsideOutline, TkFocusTrap, _sfc_main$H as TkFooterGroup, _sfc_main$G as TkFooterInfo, _sfc_main$l as TkHome, _sfc_main$w as TkHomeBanner, _sfc_main$A as TkHomeBannerBgImage, _sfc_main$B as TkHomeBannerBgPure, _sfc_main$z as TkHomeBannerContent, _sfc_main$y as TkHomeBannerFeature, _sfc_main$x as TkHomeBannerWaves, _sfc_main$m as TkHomeCardList, _sfc_main$r as TkHomeCategoryCard, _sfc_main$n as TkHomeDocAnalysisCard, _sfc_main$o as TkHomeFriendLinkCard, _sfc_main$F as TkHomeFullscreenWallpaper, _sfc_main$u as TkHomeMyCard, _sfc_main$t as TkHomeMyCardScreen, _sfc_main$E as TkHomePostItem, _sfc_main$C as TkHomePostList, _sfc_main$q as TkHomeTagCard, _sfc_main$s as TkHomeTopArticleCard, _sfc_main$1o as TkIcon, _sfc_main$1i as TkImageViewer, _sfc_main$1h as TkInputSlide, _sfc_main as TkLayout, _sfc_main$2 as TkLoginPage, message as TkMessage, _sfc_main$3 as TkNotice, _sfc_main$v as TkPageCard, _sfc_main$1a as TkPagination, _sfc_main$19 as TkPopover, _sfc_main$4 as TkRightBottomButton, _sfc_main$1 as TkRiskLinkPage, _sfc_main$17 as TkSegmented, _sfc_main$18 as TkSegmentedItem, _sfc_main$d as TkSwitch, _sfc_main$8 as TkThemeEnhance, _sfc_main$h as TkThemeEnhanceBaseTemplate, _sfc_main$16 as TkTitleTag, _sfc_main$15 as TkTransitionCollapse, _sfc_main$14 as TkVerifyCode, _sfc_main$13 as TkVpContainer, Z_INDEX_INJECTION_KEY, activateMaxWidthSlideMedia, addUnit, aliPayIcon, alignLeftIcon, alignTextLeftIcon, arrowDownIcon, arrowLeftIcon, arrowRightIcon, artalkContext, autoWidthIcon, baiduAnalytics, calendarIcon, caretTopIcon, categoryIcon, circleCloseFilledIcon, clickIcon, clockIcon, closeIcon, codeIcon, collectionTagIcon, commentIcon, copyIcon, copyrightIcon, createCardContainer, createCardContainers, createContainerThenGet, createContainerThenUse, createContainersThenGet, createContainersThenUse, createDynamicComponent, createImageViewer, dArrowLeftIcon, dArrowRightIcon, index as default, defaultInitialZIndex, defaultPrivateConfig, docAnalysisIcon, docMaxWidthSlideStorageKey, docMaxWidthVar, editPenIcon, emptyIcon, en, externalLinkIcon, folderOpenedIcon, formatDate, formatDiffDate, formatDiffDateToDay, friendLinkIcon, fullScreenOneIcon, fullscreenIcon, fullscreenTwoIcon, get, getDarkColor, getInstance, getLastOffset, getLightColor, getLoginStorageKey, getNowDate, getOffsetOrSpace, giscusContext, githubIcon, googleAnalytics, guessSerializerType, hexToRgb, houseIcon, icpRecordIcon, inBrowser, infoFilledIcon, instances, is, isArray$1 as isArray, isAsyncFunction, isBoolean$1 as isBoolean, isClient, isDate, isDef, isElement, isEmpty, isExternal, isFocusable, isFunction, isIOS, isImageDom, isImgPath, isNull$1 as isNull, isNullAndUnDef, isNullOrUnDef, isNumber, isObject$2 as isObject, isPhone, isPromise, isServer, isString$1 as isString, isStringNumber, isType, isUnDef, isValidURL, layoutIcon, layoutModeAttribute, layoutModeStorageKey, localeContextKey, lockIcon, loginUrlKeyMap, magicIcon, mobileMaxWidthMedia, moreFilledIcon, noticeIcon, ns$1 as ns, onClickOutside, overallReductionIcon, pageMaxWidthSlideStorageKey, pageMaxWidthVar, pageNumKey, playgroundIcon, postDataUpdateSymbol, postsContext, questionFilledIcon, readingIcon, refreshLeftIcon, refreshRightIcon, removeStorageItem, removeUnit, rgbToHex, rocketIcon, scaleIcon, scaleToOriginalIcon, shareIcon, size as sizeIcon, spotlightStorageKey, spotlightStyleStorageKey, successFilledIcon, tagIcon, teekConfigContext, themeBgColorStorageKey, themeColorAttribute, themeColorList, themeColorStorageKey, themeIcon, thumbsIcon, topArticleIcon, topIcon, touchMedia, trackPageview, transitionName, umamiAnalytics, upperFirst, useAllPosts, useAnchorScroll, useBuSuanZi, useClipboard, useDebounce, useElementHover, useEventListener, useLocale, useMediaQuery, useMounted, useNamespace, usePagePath, usePageState, usePopoverSize, usePosts, useRiskLink, useScopeDispose, useScrollData, useStorage, useSwitchData, useTagColor, useTeekConfig, useTextTypes, useThemeColor, useViewTransition, useVpRouter, useWatchLogin, useWindowSize, useZIndex, userIcon, varNameList, verifyModeMap, version, viewIcon, walineContext, warningFilledIcon, waterIcon, weChatPayIcon, withBase, zIndexContextKey, zhCn, zoomInIcon, zoomOutIcon };
