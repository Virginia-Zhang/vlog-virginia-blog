...
var _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const { pagePv, isGet, request } = useBuSuanZi.useBuSuanZi(usePageView.value, {
    ...
    return (_ctx, _cache) => {
      return Vue.openBlock(), Vue.createElementBlock("div", {
        ...
        Vue.createVNode(Vue.unref(index_vue_vue_type_script_setup_true_name_ArticleBreadcrumb_lang.default)),
        isShowInfo.value ? (Vue.openBlock(), Vue.createElementBlock(
          ...
          [
            ...
            usePageView.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_6, [
              ...
              }, Vue.toDisplayString(statisticsInfo.value.isGet ? statisticsInfo.value.pagePv : "Get..."), 9, _hoisted_7)
            ])) : Vue.createCommentVNode("v-if", true)
          ],
          2
          /* CLASS */
