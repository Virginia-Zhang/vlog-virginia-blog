  ...
  setup(__props) {
    ...
    const scrollToComment = useDebounce.useDebounce(
      () => {
        ...
        document.querySelector(`#${namespace.ns.joinNamespace("comment")}`)?.scrollIntoView({ behavior: "smooth" });
        setTimeout(() => {
          toCommentDone.value?.(method.default);
        }, 600);
      },
      500,
      true
    ...
    return (_ctx, _cache) => {
      return Vue.openBlock(), Vue.createBlock(Vue.Transition, {
        name: Vue.unref(namespace.ns).joinNamespace("fade"),
        persisted: ""
      }, {
        default: Vue.withCtx(() => [
