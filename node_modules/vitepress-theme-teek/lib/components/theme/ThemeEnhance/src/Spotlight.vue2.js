...
var _sfc_main = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    ...
    const isMobile = useMediaQuery.useMediaQuery(themeEnhance.touchMedia);
    ...
    return (_ctx, _cache) => {
      return Vue.openBlock(), Vue.createElementBlock(
        ...
        [
          ...
          Vue.unref(spotlight) && !Vue.unref(isMobile) ? (Vue.openBlock(), Vue.createBlock(SpotlightHover_vue_vue_type_script_setup_true_name_SpotlightHover_lang.default, {
            key: 0,
