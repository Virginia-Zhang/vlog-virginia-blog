        ...
        props.enabled && !shouldRecalculate.value ? (Vue.openBlock(), Vue.createElementBlock(
          "div",
          {
            ...
            class: Vue.normalizeClass([
              Vue.unref(namespace.ns).joinNamespace("spotlight-hover"),
              Vue.unref(spotlightStyle) === Vue.unref(themeEnhance.SpotlightStyle).Under ? Vue.unref(namespace.ns).joinNamespace("spotlight-hover__under") : "",
              Vue.unref(spotlightStyle) === Vue.unref(themeEnhance.SpotlightStyle).Aside ? Vue.unref(namespace.ns).joinNamespace("spotlight-hover__aside") : ""
            ]),
            "aria-hidden": "true",
            focusable: "false"
          },
