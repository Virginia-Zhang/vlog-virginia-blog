    ...
    (card) => `
            ...
            >
              <div class="${rootClass}__item__info">
                ${card.img ? `<img src="${index.withBase(base, card.img)}" class="no-preview">` : ""}
